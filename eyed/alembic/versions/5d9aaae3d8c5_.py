...
Revision ID: 5d9aaae3d8c5
Revises: 
Create Date: 2018-06-03 19:22:04.720132
...
def upgrade():
    ...
    op.create_table('M_BACNET_MEASURED_VALUES',
    sa.Column('ID', sa.Integer(), nullable=False),
    sa.Column('DATETIME', sa.DATETIME(), nullable=False),
    sa.Column('VALUE', sa.String(), nullable=True),
    sa.Column('M_BACNET_TASK_ID', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['M_BACNET_TASK_ID'], ['M_BACNET_TASK.ID'], ),
    sa.PrimaryKeyConstraint('ID')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('M_BACNET_MEASURED_VALUES')
